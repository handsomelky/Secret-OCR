...
class Translator(QObject):
    ...
    def __init__(self, parent=None):
        ...
        self.protection = self.tr('Protection')
        self.textProtection = self.tr('Text Protection')
        self.metadataClean = self.tr('Metadata Clean')
        self.textBlurring = self.tr('Text Blurring')
        self.faceProtection = self.tr('Face Protection')
